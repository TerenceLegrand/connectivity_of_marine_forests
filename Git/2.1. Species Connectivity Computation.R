## ------------------------------------------------------------------------------------------------------------------
## PlankTonic
## Terence Legrand from Assis et al., 2017
## ------------------------------------------------------------------------------------------------------------------
##
## ------------------------------------------------------------------------------------------------------------------
...
if( ! exists("pipeLiner") ) { # TL: because 5.1 Pipeliner process 5.1 connectivity estimates for all the season/PD combinations, if 5.1 Pipeliner was not proceed, we have to define a season/PLD
